...
public class ShopInfoActivity extends BaseRxFluxToolbarActivity {
    @Inject
    ShopInfoStore mStore;

    public static Intent newIntent(Context content) {
        Intent intent = new Intent(content, ShopInfoActivity.class);
        return intent;
    }
    ...
    public void afterCreate(Bundle savedInstanceState) {
        getFragmentTransaction(R.id.fl_content)
                .add(R.id.fl_content, ShopInfoShowFragment.newInstance(mLocalStorageUtils.getShop()))
                .commit();
    }
