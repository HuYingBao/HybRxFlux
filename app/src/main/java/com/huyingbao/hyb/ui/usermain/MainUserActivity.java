 ...
 */
public class MainUserActivity extends BaseRxFluxToolbarActivity implements View.OnClickListener {
    @Inject
    RxFlux mRxFlux;
    @Inject
    ...
    public static Intent newIntent(Context context) {
        return new Intent(context, MainUserActivity.class);
    }
    ...
    public void afterCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction()
                .add(R.id.fl_content, MainUserFragment.newInstance())
                .commit();
    }
    ...
    private void initNavView() {
        ...
        View headerView = LayoutInflater.from(mContext).inflate(R.layout.view_nav_main_user, null);
