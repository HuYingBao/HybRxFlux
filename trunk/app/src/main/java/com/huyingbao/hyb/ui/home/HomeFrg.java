...
public class HomeFrg extends BaseFragment implements RxViewDispatch, RepoAdapter.OnRepoClicked {
    ...
    public void onRxViewRegistered() {
        ...
        repositoriesStore = RepositoriesStore.get(SampleApp.get(getContext()).getRxFlux().getDispatcher());
        repositoriesStore.register();
        usersStore = UsersStore.get(SampleApp.get(getContext()).getRxFlux().getDispatcher());
        usersStore.register();
    }
